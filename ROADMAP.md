...
- **0.4.2 released** (2026-07-18) — UI polish from user feedback: fixed a zoom bug that spawned windows; double-click-to-open; bigger regular-weight page numbers; distinct fit-page/actual-size icons; centred settings tabs; right-aligned zoom group; dropdown chevrons.
- **0.4.1 released** (2026-07-18) — UI icons moved to the Lucide set.
